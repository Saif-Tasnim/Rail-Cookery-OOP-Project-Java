...
public class AdminStaffChatController extends Thread implements Initializable {
    @FXML
...
//    String Name1,Password1,email1,phone1,gender1 = "";
    ...
    public void send() throws SQLException, ClassNotFoundException {
        ...
        String sql="INSERT INTO admin_staff(`name`,massage) VALUES (?,?)";
...
//        msgRoom.setText("bob\n");
        ...
        try {
            Class.forName(driver);
            Connection conn = DriverManager.getConnection(databaseurl, username, passwords);
            String sql = "SELECT * FROM admin_staff ";
...
//            pst.setString(1, sid1);
    ...
    void back(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("select_type_for_admin.fxml"));
        Scene sc = new Scene(root);
        Stage st = (Stage)((Node)event.getSource()).getScene().getWindow();
        st.setScene((sc));
        st.show();
