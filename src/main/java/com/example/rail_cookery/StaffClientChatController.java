...
public class StaffClientChatController extends Thread implements Initializable {
    @FXML
...
//    String Name1,Password1,email1,phone1,gender1 = "";
    ...
    public void send() throws SQLException, ClassNotFoundException {
        ...
        String sql="INSERT INTO user_staff(`name`,massage) VALUES (?,?)";
        PreparedStatement ps = conn.prepareStatement(sql);
        String fs = f_name+ " (Staff) ";
        ps.setString(1,fs);
        ps.setString(2,msg);
...
//        msgRoom.setText("bob\n");
        ...
        try {
            Class.forName(driver);
            Connection conn = DriverManager.getConnection(databaseurl, username, passwords);
            String sql = "SELECT * FROM user_staff ";
